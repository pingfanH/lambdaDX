...
pub enum SimaiNote {
    Tap {
        ...
        is_ex: bool,
        is_star: bool,
        /// Note-speed multiplier from `[x]` hi-speed markers (default 1.0).
        hi_speed: f32,
    },
    Hold {
        measure: f32,
    ...
    Slide {
        ...
        delay: f32,
        /// True when the delay came from an explicit `[delay##duration]` form,
        /// so a value of `0` means "no wait" instead of "use the default".
        delay_explicit: bool,
        is_break: bool,
        is_ex: bool,
