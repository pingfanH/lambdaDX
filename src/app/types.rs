...
pub(crate) const TAP_TRAVEL_TIME: f32 = 0.40;
pub(crate) const TOUCH_TRAVEL_TIME: f32 = 0.40;
pub(crate) const HOLD_TRAVEL_TIME: f32 = 0.40;
...
pub(crate) const HOLD_TAIL_FLY_TIME: f32 = 0.15;
pub(crate) const HOLD_LENGTH_FRAC: f32 = 0.3;
