    ...
    egui::Frame::new()
        ...
        .show(ui, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                // Time display
                ui.label(
                    egui::RichText::new("0:04.230 / 1:23.456")
            ...
            ui.painter()
                .rect_filled(ruler_rect.rect, CornerRadius::ZERO, BG_RULER);
            ...
            let lanes_rect = ui.allocate_rect(
                egui::Rect::from_min_size(
                    ui.cursor().left_top(),
                    Vec2::new(available.x, lanes_h.max(80.0)),
                ),
                egui::Sense::hover(),
            );
            ui.painter()
                .rect_filled(lanes_rect.rect, CornerRadius::ZERO, BG_LANE);
            ...
            for (frac, lane, color) in &notes {
                let nx =
                    lanes_rect.rect.left() + label_w + (lanes_rect.rect.width() - label_w) * frac;
            ...
            // Hold note
            let hold_x =
                lanes_rect.rect.left() + label_w + (lanes_rect.rect.width() - label_w) * 0.35;
            ...
            ui.painter()
                .circle_filled(Pos2::new(hold_x, hold_y), 6.0, ACCENT_BLUE);
            ui.painter()
                .circle_filled(Pos2::new(hold_x + hold_w, hold_y), 6.0, ACCENT_BLUE);
