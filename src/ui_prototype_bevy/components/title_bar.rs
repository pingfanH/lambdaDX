...
use egui_macroquad::egui::{self, CornerRadius, Stroke, StrokeKind, Vec2};
    ...
    egui::Frame::new()
        ...
        .show(ui, |ui| {
            ui.horizontal(|ui| {
                ...
                ui.painter()
                    .circle_filled(icon_rect.center(), 10.0, ACCENT_YELLOW);
                ui.add_space(8.0);
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    // Search box
                    let search_rect =
                        ui.allocate_response(Vec2::new(130.0, 22.0), egui::Sense::hover());
                    ui.painter()
                        .rect_filled(search_rect.rect, CornerRadius::same(4), BG_SEARCH);
                    ui.painter().rect_stroke(
                        search_rect.rect,
                        CornerRadius::same(4),
                        Stroke::new(1.0_f32, BORDER_PANEL),
                        StrokeKind::Outside,
                    );
                    ui.painter().text(
